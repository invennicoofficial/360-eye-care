...
const TermsConditions = () => {
  return (
    <main className="pt-[110px]">
      <SubHeader text="Terms of Service & Conditions" />
      <div className="max-w-6xl mx-auto my-8 md:my-16 px-4 md:px-0">
        ...
        <p className="text-neutral-500 text-base font-normal mb-4">
          This website is operated by 360 Eyecare. Throughout the site, the
          terms "we", "us" and "our" refer to 360 Eyecare. 360 Eyecare offers
        ...
        <p className="text-neutral-500 text-base font-normal mb-6 md:mb-8">
          Our store is hosted on WooCommerce. They provide us with the online
        ...
        <section className="mb-8 md:mb-10">
          <h2 className="text-combination-200 text-2xl md:text-[30px] font-bold mb-4">
        ...
        {/* Remaining sections (7-20) follow the same pattern... */}
        ...
        <section className="mb-8 md:mb-10">
          ...
          <p className="text-neutral-500 text-base font-normal mb-4">
            In no case shall 360 Eyecare, our directors, officers, employees,
        ...
        <section className="mb-8 md:mb-10">
          ...
          <p className="text-neutral-500 text-base font-normal mb-4">
            You agree to indemnify, defend and hold harmless 360 Eyecare and our
