...
import { MauiJimImage } from "../../../constants/brand";
import {
  MauiJimGolf,
    ...
    <main className="pt-[110px]">
      ...
      <div className="max-w-[1172px] mx-auto ">
        <div className="flex flex-wrap justify-between items-center">
          ...
          <Image src={MauiJimImage} alt="MauiJimImage" />
          ...
          <p className="text-neutral-500 m-2">
          ...
          {data1.map((item, index) => (
            <div key={index} className="w-full">
              <TitleCommon
                title={item.title}
                position="start"
                css="font-[400] text-[30px]"
              />
              {item.description &&
                item.description.map((desc, idx) => (
                  <p key={idx} className="text-neutral-500 mt-2">
                    {desc}
                  </p>
                ))}
            </div>
        ...
        <div className="flex items-center gap-8">
          <div className="max-w-[46%] gap-8 flex flex-col items-start justify-start">
            <div>
              <TitleCommon
          ...
          <div className="max-w-[50%] flex flex-col items-start justify-start">
            <Image src={MauiJimGolf} alt="MauiJimGolf " />
          </div>
        </div>
